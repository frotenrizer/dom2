...
const jugador4= new jugadores("UNTITI","real", "frances","liga esp", 900,0)
...
function nuevojugador(){
    ...
    // length dinámica
    let jugadorcreado = new jugadores(estadisticas.length+1,jugadorIngresado, equipoIngresado, nacionalidad ,)
    console.log(jugadorcreado)
    //Push de jugador al array
